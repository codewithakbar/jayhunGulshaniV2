...
from data.config import CHANNELS, CHANNELS2
...
async def checker(call: types.CallbackQuery):
    ...
    if final_status:
        ...
        await call.message.answer(msg, reply_markup=categories_markup())
    else:
        await call.message.delete()
        await call.message.answer(result, disable_web_page_preview=True, reply_markup=categories_markup())